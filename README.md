...
- HomeScreen guide: [`HomeScreen.md`](docs/HomeScreen.md)
...
```text
assets/
├── bg/  # Background PNGs used for the Homescreen
│   ├── bg3rc2.png
│   └── bg6rc2.png
└── ha-icons/  # PNG Icons used for HomeAssistant elements
    ├── ac.png
    ├── dryer.png
    ├── fan.png
    ├── lightbulb.png
    └── ... (Icons updated via json data of mqtt)
